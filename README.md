...
現在ソース版は`gpt-connector@0.9.12`。`setup`がnpm導入・MCP登録・ブラウザ準備・CodexへのSteer接続・診断を所有します。
...
- liveブラウザ機能にはmacOS、Windows、またはLinuxの公式Google Chromeと、ChatGPTへログインできるaccount。
